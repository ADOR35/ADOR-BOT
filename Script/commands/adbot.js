...
module.exports.run = async ({ api, event, args }) => {
    ...
    if (args[0] == "admin") {
        let callback = () => api.sendMessage(
            {
                body: `———»ADMIN BOT«———\n❯ Name: ADOR 𝐒𝐀𝐇𝐔\n❯ Facebook: https://facebook.com/61578654179767\n❯ Thanks for using ${global.config.BOTNAME} bot`,
        ...
        return request(encodeURI(`https://graph.facebook.com/61578654179767/picture?height=720&width=720&access_token=6628568379%7Cc1e620fa708a1d5696fb991c1bde5662`))
